...
/** * Sends password reset email (table structure for compatibility).
 * @param {object} details - Admin name, email, and reset URL.
 */
export async function sendPasswordResetEmail({ email, name, resetUrl }) {
  try {
    const defaultFrom = 'Somali Soc Reset <noreply@somsocsal.com>'; // Defined here for clarity
